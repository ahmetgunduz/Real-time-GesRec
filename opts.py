...
def parse_opts_offline():
    ...
    parser.add_argument(
        ...
        default='RGB', 
        type=str, 
        help='Modality of input data. RGB, Depth, or RGB-D')
    parser.add_argument(
        '--dataset',
        default='kinetics',
        type=str,
...
def parse_opts_online():
    ...
    parser.add_argument('--n_classes_det', default=400, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
    parser.add_argument('--n_finetune_classes_det', default=400, type=int, help='Number of classes for fine-tuning. n_classes is set to the number when pretraining.')
    parser.add_argument('--n_classes_clf', default=400, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
    parser.add_argument('--n_finetune_classes_clf', default=400, type=int, help='Number of classes for fine-tuning. n_classes is set to the number when pretraining.')
    ...
    parser.add_argument('--lr_steps', default=[10, 20, 30, 40, 100], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
    ...
    parser.add_argument('--model_det', default='resnet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
    ...
    parser.add_argument('--model_clf', default='resnet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
    ...
    parser.add_argument('--clf_threshold_final', default=1, type=float, help='Cumulative sum threshold to predict at the end')
